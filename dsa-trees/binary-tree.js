...
//   return Math.min(minDepthHelper(node2), minDepthHelper(node3)) +1; 
//   node2   -> 1


//   ld = 2
//   node3
//   return Math.min(minDepthHelper(node4), minDepthHelper(node5)) +1; 
//   node4
//   if(node.right === null) return minDepthHelper(node6)  + 1;
//   node6
//   1

//   ld =3   
//   if(node.right === null) return minDepthHelper(node5)  + 1;
//   1
//   rd = 2
